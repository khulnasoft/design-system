...
module('Acceptance | Component | kds/pagination', function (hooks) {
  ...
  test('interacting with the demo of a "numbered" pagination with routing', async function (assert) {
    ...
    assert
      .dom(
        '#demo2-numbered-with-routing .kds-table .kds-table__tbody .kds-table__tr'
      )
      .exists({ count: 5 });

    await click(
      '#demo2-numbered-with-routing .kds-pagination .kds-pagination-nav__arrow--direction-next'
    );
    assert.strictEqual(
      currentURL(),
    ...
    await click(
      '#demo2-numbered-with-routing .kds-pagination-nav__page-item:nth-child(4) a'
    );
    assert.strictEqual(
      currentURL(),
    ...
    await click(
      '#demo2-numbered-with-routing .kds-pagination .kds-pagination-nav__arrow--direction-prev'
    );
    assert.strictEqual(
      currentURL(),
    ...
    await select(
      '#demo2-numbered-with-routing .kds-pagination .kds-pagination-size-selector select',
      '10'
    );
    assert
      .dom(
  ...
  test('interacting with the demo of a "compact" pagination with routing', async function (assert) {
    ...
    assert
      .dom(
        '#demo4-compact-with-routing .kds-table .kds-table__tbody .kds-table__tr'
      )
      .exists({ count: 5 });
    assert
      .dom(
        '#demo4-compact-with-routing .kds-table .kds-table__tbody .kds-table__tr .kds-table__td'
      )
      .hasText('1');
    assert
      .dom(
        '#demo4-compact-with-routing .kds-table .kds-table__tbody .kds-table__tr:nth-child(5) .kds-table__td'
      )
      .hasText('5');
    ...
    await click(
      '#demo4-compact-with-routing .kds-pagination .kds-pagination-nav__arrow--direction-next'
    );
    ...
    await select(
      '#demo4-compact-with-routing .kds-pagination .kds-pagination-size-selector select',
      '10'
    );
    assert
      .dom(
    ...
    assert
      .dom(
        '#demo4-compact-with-routing .kds-table .kds-table__tbody .kds-table__tr:nth-child(10) .kds-table__td'
      )
      .hasText('15');
    ...
    await click(
      '#demo4-compact-with-routing .kds-pagination .kds-pagination-nav__arrow--direction-prev'
    );
    assert.strictEqual(
      currentURL(),
