...
module('Integration | Component | kds/form/textarea/base', function (hooks) {
  setupRenderingTest(hooks);

  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(kbs`<Kds::Form::Textarea::Base id="test-form-textarea" />`);
    assert.dom('#test-form-textarea').hasClass('kds-form-textarea');
  });
  ...
  test('it should render the input with the value provided via @value argument', async function (assert) {
    await render(
      kbs`<Kds::Form::Textarea::Base @value="abc123" id="test-form-textarea" />`
    );
  ...
  test('it should render the textarea with the default number of rows', async function (assert) {
    await render(kbs`<Kds::Form::Textarea::Base />`);
  ...
  test('it should render the textarea with a custom number of rows', async function (assert) {
    await render(kbs`<Kds::Form::Textarea::Base rows="2" />`);
  ...
  test('it should render the correct CSS class if the @isInvalid prop is declared', async function (assert) {
    await render(
      kbs`<Kds::Form::Textarea::Base id="test-form-textarea" @isInvalid={{true}} />`
    );
    assert.dom('#test-form-textarea').hasClass('kds-form-textarea--is-invalid');
  });
});
