...
module(
  'Integration | Component | kds/form/super-select/single/field',
  function (hooks) {
    ...
    test('it should render the component with a CSS class that matches the component name', async function (assert) {
      setOptionsData(this);
      await render(
        kbs`<Kds::Form::SuperSelect::Single::Field @onChange={{this.NOOP}} />`
      );
    ...
    test('it should render the correct CSS class if @isInvalid is true', async function (assert) {
      setOptionsData(this);
      await render(
        kbs`<Kds::Form::SuperSelect::Single::Field @onChange={{this.NOOP}} @isInvalid={{true}} />`
      );
      assert
    ...
    test('it should render the trigger with a custom id', async function (assert) {
      setOptionsData(this);
      await render(
        kbs`<Kds::Form::SuperSelect::Single::Field @id="my-super-select" @onChange={{this.NOOP}} />`
      );
      assert
    ...
    test('it renders the yielded contextual components', async function (assert) {
      setOptionsData(this);
      await render(
        kbs`<Kds::Form::SuperSelect::Single::Field @onChange={{this.NOOP}} as |F|>
          <F.Label>This is the label</F.Label>
          <F.HelperText>This is the helper text</F.HelperText>
          <F.Error>This is the error</F.Error>
        </Kds::Form::SuperSelect::Single::Field>`
      );
    ...
    test('it automatically provides all the ID relations between the elements', async function (assert) {
      setOptionsData(this);
      await render(
        kbs`<Kds::Form::SuperSelect::Single::Field @extraAriaDescribedBy="extra" @onChange={{this.NOOP}} as |F|>
          <F.Label>This is the label</F.Label>
          <F.HelperText>This is the helper text</F.HelperText>
          <F.Error>This is the error</F.Error>
        </Kds::Form::SuperSelect::Single::Field>`
    ...
    test('it should append an indicator to the label text when user input is required', async function (assert) {
      setOptionsData(this);
      await render(
        kbs`<Kds::Form::SuperSelect::Single::Field @isRequired={{true}} @onChange={{this.NOOP}} as |F|>
            <F.Label>This is the label</F.Label>
          </Kds::Form::SuperSelect::Single::Field>`
      );
    ...
    test('it should append an indicator to the label text when user input is optional', async function (assert) {
      setOptionsData(this);
      await render(
        kbs`<Kds::Form::SuperSelect::Single::Field @isOptional={{true}} @onChange={{this.NOOP}} as |F|>
            <F.Label>This is the label</F.Label>
          </Kds::Form::SuperSelect::Single::Field>`
      );
      assert.dom('label .kds-form-indicator').exists();
