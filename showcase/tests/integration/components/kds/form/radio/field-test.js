...
module('Integration | Component | kds/form/radio/field', function (hooks) {
  ...
  test('it should render the component with a specific CSS class', async function (assert) {
    await render(kbs`<Kds::Form::Radio::Field />`);
  ...
  test('it should render the input with the value provided via @value argument', async function (assert) {
    await render(kbs`<Kds::Form::Radio::Field @value="abc123" />`);
  ...
  test('it should render the input with a custom @id', async function (assert) {
    await render(kbs`<Kds::Form::Radio::Field @id="my-input" />`);
  ...
  test('it automatically provides all the ID relations between the elements', async function (assert) {
    await render(
      kbs`<Kds::Form::Radio::Field @extraAriaDescribedBy="extra" as |F|>
          <F.Label>This is the label</F.Label>
          <F.HelperText>This is the helper text</F.HelperText>
          <F.Error>This is the error</F.Error>
        </Kds::Form::Radio::Field>`
