...
module(
  'Integration | Component | kds/form/character-count/index',
  function (hooks) {
    ...
    test('it should render the component with a CSS class that matches the component name', async function (assert) {
      await render(
        kbs`<Kds::Form::CharacterCount id="test-form-character-count" />`
      );
      assert
        .dom('#test-form-character-count')
        .hasClass('kds-form-character-count');
    });
    test('it should render with a CSS class provided via the @contextualClass argument', async function (assert) {
      await render(
        kbs`<Kds::Form::CharacterCount @contextualClass="my-class" id="test-form-character-count" />`
      );
    ...
    test('it renders a character count with the correct "id" attribute if the @controlId argument is provided', async function (assert) {
      await render(
        kbs`<Kds::Form::CharacterCount @controlId="my-control-id"/>`
      );
    ...
    test('it renders a character count with the default predefined format', async function (assert) {
      await render(
        kbs`
          ...
          <Kds::Form::CharacterCount @value={{this.value}} @controlId="input-1" id="test-form-character-count"/>`
      );
    ...
    test('it renders a character count in the predefined format when only @maxLength is set', async function (assert) {
      await render(
        kbs`
          ...
          <Kds::Form::CharacterCount @value={{this.value}} @maxLength={{25}} @controlId="input-max-length" id="test-form-character-count"/>`
      );
    ...
    test('it renders a character count in the predefined format when only @minLength is set', async function (assert) {
      await render(
        kbs`
          ...
          <Kds::Form::CharacterCount @value={{this.value}} @minLength={{3}} @controlId="input-min-length" id="test-form-character-count"/>`
      );
    ...
    test('it renders a character count in the predefined format when both @minLength and @maxLength are set', async function (assert) {
      await render(
        kbs`
          ...
          <Kds::Form::CharacterCount @value={{this.value}} @minLength={{3}} @maxLength={{25}} @controlId="input-minmax-length" id="test-form-character-count"/>`
      );
      assert.dom('#test-form-character-count').hasText('3 characters required');
    ...
    test('it renders a character count in custom format', async function (assert) {
      ...
      await render(
        ...
        <Kds::Form::CharacterCount @value={{this.value}} @minLength={{20}} @maxLength={{40}} @controlId="input-2" id="test-form-character-count" as |CC|>
    ...
    test('it should present the character count as a live region', async function (assert) {
      ...
      await render(
        kbs`
          ...
          <Kds::Form::CharacterCount @maxLength={{40}} @controlId="input-3" id="test-form-character-count"/>`
      );
      assert
        .dom('#test-form-character-count')
