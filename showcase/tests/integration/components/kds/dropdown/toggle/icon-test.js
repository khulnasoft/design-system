...
module('Integration | Component | kds/dropdown/toggle/icon', function (hooks) {
  ...
  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(
      kbs`<Kds::Dropdown::Toggle::Icon @icon="user" @text="toggle text" id="test-toggle-icon" />`
    );
    assert.dom('#test-toggle-icon').hasClass('kds-dropdown-toggle-icon');
  });
  ...
  test('if an @icon is declared the flight icon should render in the component', async function (assert) {
    await render(
      kbs`<Kds::Dropdown::Toggle::Icon @icon="settings" @text="settings menu" id="test-toggle-icon" />`
    );
    assert.dom('.kds-icon.kds-icon-settings').exists();
  });
  ...
  test('if an @imageSrc is declared and exists the image should render in the component', async function (assert) {
    await render(
      kbs`<Kds::Dropdown::Toggle::Icon @icon="user" @text="user menu" @imageSrc="/assets/images/avatar.png" id="test-toggle-icon" />`
    );
  ...
  skip('if an @imageSrc is declared but does not exist, the flight icon should render in the component', async function (assert) {
    ...
    await render(
      kbs`<Kds::Dropdown::Toggle::Icon @icon="user" @text="user menu" @imageSrc={{this.imageSrc}} id="test-toggle-icon" />`
    );
    ...
    assert.dom('#test-toggle-icon .kds-icon.kds-icon-user').exists();
  });
  ...
  test('it should render the chevron "down" by default', async function (assert) {
    await render(
      kbs`<Kds::Dropdown::Toggle::Icon @icon="user" @text="user menu" id="test-toggle-icon" />`
    );
  ...
  test('toggle-icon renders no chevron when hasChevron is set to false', async function (assert) {
    await render(
      kbs`<Kds::Dropdown::Toggle::Icon @icon="user" @text="user menu" id="test-toggle-icon" @hasChevron={{false}} />`
    );
    assert.dom('.kds-icon.kds-icon-chevron-down').doesNotExist();
  });
  ...
  test('it should render the medium size as the default if no size is declared', async function (assert) {
    ...
    assert
      ...
      .hasClass('kds-dropdown-toggle-icon--size-medium');
  });
  test('it should render the correct CSS size class if the @size prop is declared', async function (assert) {
    await render(
      kbs`<Kds::Dropdown::Toggle::Icon @icon="user" @text="user menu" @size="small" id="test-toggle-icon" />`
    );
    assert
      .dom('#test-toggle-icon')
      .hasClass('kds-dropdown-toggle-icon--size-small');
  });
  ...
  test('it should render with the correct aria-expanded attribute on the toggle element', async function (assert) {
    await render(
      kbs`<Kds::Dropdown::Toggle::Icon @icon="user" @text="user menu" @isOpen={{true}} id="test-toggle-icon" />`
    );
  ...
  test('it should throw an assertion if @text is not defined', async function (assert) {
    const errorMessage = `@text for "Kds::Dropdown::Toggle::Icon" must have a valid value`;
    assert.expect(2);
    setupOnerror(function (error) {
      assert.strictEqual(error.message, `Assertion Failed: ${errorMessage}`);
    });
    await render(
      kbs`<Kds::Dropdown::Toggle::Icon @icon="user" id="test-toggle-icon" />`
    );
  ...
  test('it should throw an assertion if both @icon and @imageSrc are not defined', async function (assert) {
    ...
    await render(kbs`<Kds::Dropdown::Toggle::Icon @text="user menu" />`);
    assert.throws(function () {
      throw new Error(errorMessage);
    });
  });
  test('it should throw an assertion if an incorrect value for @size is provided', async function (assert) {
    const errorMessage =
      '@size for "Kds::Dropdown::Toggle::Icon" must be one of the following: small, medium; received: foo';
    assert.expect(2);
    setupOnerror(function (error) {
      assert.strictEqual(error.message, `Assertion Failed: ${errorMessage}`);
    });
    await render(
      kbs`<Kds::Dropdown::Toggle::Icon @icon="user" @text="user menu" @size="foo" />`
    );
    assert.throws(function () {
      throw new Error(errorMessage);
    });
