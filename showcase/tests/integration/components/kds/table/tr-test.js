...
module('Integration | Component | kds/table/tr', function (hooks) {
  setupRenderingTest(hooks);

  test('it should render with a CSS class that matches the component name', async function (assert) {
    await render(kbs`<Kds::Table::Tr id="data-test-table-tr"/>`);
    assert.dom('#data-test-table-tr').hasClass('kds-table__tr');
  });
  ...
  test('it should render the yielded content', async function (assert) {
    await render(
      kbs`<Kds::Table::Tr id="data-test-table-tr"><td></td></Kds::Table::Tr>`
    );
  ...
  const checkboxSelector =
    '#data-test-table-tr > .kds-table__th--is-selectable input.kds-table__checkbox';

  test('it should render a checkbox if `@isSelectable` is `true`', async function (assert) {
    await render(
      kbs`<Kds::Table::Tr id="data-test-table-tr" @isSelectable={{true}} />`
    );
  ...
  test('the checkbox should be checked if `@isSelected` is `true`', async function (assert) {
    await render(
      kbs`<Kds::Table::Tr id="data-test-table-tr" @isSelectable={{true}} @isSelected={{true}} />`
    );
  ...
  test('the checkbox contains the `@selectionAriaLabelSuffix` suffix', async function (assert) {
    await render(
      kbs`<Kds::Table::Tr id="data-test-table-tr" @isSelectable={{true}} @selectionAriaLabelSuffix="row 123" />`
    );
    assert.dom(checkboxSelector).hasAria('label', 'Select row 123');
    await render(
      kbs`<Kds::Table::Tr id="data-test-table-tr" @isSelectable={{true}} @isSelected={{true}} @selectionAriaLabelSuffix="row 123" />`
    );
  ...
  test('the `th` element has the correct `scope` attribute value provided via `@selectionScope`', async function (assert) {
    await render(
      kbs`<Kds::Table::Tr id="data-test-table-tr" @isSelectable={{true}} @selectionScope="test-selectionscope" />`
    );
    assert
      .dom('#data-test-table-tr > .kds-table__th--is-selectable')
  ...
  test('it should invoke the `onSelectionChange` callback when the checkbox is selected', async function (assert) {
    ...
    await render(
      kbs`<Kds::Table::Tr id="data-test-table-tr" @isSelectable={{true}} @selectionScope="row" @selectionKey="row123" @onSelectionChange={{this.onSelectionChange}} />`
    );
  ...
  test('it should render a sort button in the checkbox cell if `@onClickSortBySelected` is provided and `@isSelectable` is `true`', async function (assert) {
    ...
    await render(
      kbs`<Kds::Table::Tr id="data-test-table-tr" @isSelectable={{true}} @onClickSortBySelected={{this.noop}} />`
    );

    assert.dom(checkboxSelector + ' ~ .kds-table__th-button--sort').exists();
  });
  ...
  test('it should not render a sort button in the checkbox cell if `@isSelectable` is `true`, and `@onClickSortBySelected` is undefined', async function (assert) {
    ...
    assert
      .dom(checkboxSelector + ' + .kds-table__th-button--sort')
      .doesNotExist();
  });
  ...
  test('it should support splattributes', async function (assert) {
    await render(kbs`<Kds::Table::Tr id="data-test-table-tr" lang="es" />`);
  ...
  test('it should throw an error if @selectionKey is not defined when @isSelectable is `true` and @selectionScope is `row`', async function (assert) {
    ...
    await render(
      kbs`<Kds::Table::Tr @isSelectable={{true}} @selectionScope="row" />`
    );
