...
module('Integration | Component | kds/side-nav/portal', function (hooks) {
  setupRenderingTest(hooks);

  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(
      kbs`<Kds::SideNav::Portal::Target id="test-side-nav-portal-target" />`
    );
    assert
      .dom('#test-side-nav-portal-target')
      .hasClass('kds-side-nav__content');
  });
  ...
  test('we can use custom a custom name for the target portal', async function (assert) {
    await render(kbs`
      <Kds::SideNav::Portal::Target @targetName="test-side-nav-portal-target" />
      <Kds::SideNav::Portal @targetName="test-side-nav-portal-target">
        <div id="test-side-nav-content-portaled" />
      </Kds::SideNav::Portal>
    `);
    assert.dom('#test-side-nav-content-portaled').exists();
  ...
  test('it renders the panel items provided via portal, in the right DOM location', async function (assert) {
    await render(kbs`
      <Kds::SideNav::Portal::Target id="test-side-nav-content" />
      <Kds::SideNav::Portal as |Nav|>
    ...
    assert
      .dom(
        '#test-side-nav-content .kds-side-nav__content-panels .kds-side-nav__content-panel'
      )
      .exists();
    assert
    ...
    assert
      ...
      .hasClass('kds-side-nav__list-title');
  ...
  test('it should render with the correct aria-label attribute passed down to the "list" parent', async function (assert) {
    await render(kbs`
      <Kds::SideNav::Portal::Target />
      <Kds::SideNav::Portal @ariaLabel="test">
        <div/>
      </Kds::SideNav::Portal>
    `);
    assert
      .dom('.kds-side-nav__list-wrapper')
  ...
  test('it marks inactive subnavs', async function (assert) {
    await render(kbs`
      <Kds::SideNav::Portal::Target />
      <Kds::SideNav::Portal data-test-side-nav-panel as |Nav|>
  ...
  test('it sets transform on the container', async function (assert) {
    ...
    assert
      .dom('.kds-side-nav__content-panels')
