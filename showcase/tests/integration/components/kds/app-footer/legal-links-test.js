...
module(
  'Integration | Component | kds/app-footer/legal-links',
  function (hooks) {
    setupRenderingTest(hooks);

    test('it should render the component with a CSS class that matches the component name', async function (assert) {
      await render(
        kbs`<ul><Kds::AppFooter::LegalLinks id="test-legal-links" /></ul>`
      );
      assert.dom('#test-legal-links').hasClass('kds-app-footer__legal-links');
    });
    ...
    test('it contains the default links with default href values', async function (assert) {
      ...
      assert
        ...
        .hasText('Support')
        .hasAttribute('href', 'https://www.khulnasoft.com/support');
      assert
        .dom('#test-legal-links li:nth-child(2) a')
        .hasText('Terms')
        .hasAttribute('href', 'https://www.khulnasoft.com/terms-of-service');
      assert
        .dom('#test-legal-links li:nth-child(3) a')
        .hasText('Privacy')
        .hasAttribute('href', 'https://www.khulnasoft.com/privacy');
      assert
        .dom('#test-legal-links li:nth-child(4) a')
        .hasText('Security')
        .hasAttribute('href', 'https://www.khulnasoft.com/security');
      assert
        .dom('#test-legal-links li:nth-child(5) a')
        .hasText('Accessibility')
        .hasAttribute('href', 'https://www.khulnasoft.com/accessibility');
    });
