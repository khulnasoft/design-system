...
//
// Notice:
// - the file needs to live at the same level as the config file and `***.md` changeset files, otherwise it triggers an error "[Error: ENOENT: no such file or directory, open '/PATH/TO/khulnasoft/design-system/.changeset/SUBFOLDER/changes.md']"
