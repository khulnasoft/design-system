...
As an overlaying component, the `Kds::Flyout` is rendered on the [top layer](https://developer.mozilla.org/en-US/docs/Glossary/Top_layer), meaning it is always placed on top of all other elements in the page.
...
{{#if this.basicFlyoutActive}}
  <Kds::Flyout id="basic-flyout"
    ...
    <M.Body>
      <p class="kds-typography-body-300 kds-foreground-primary">
