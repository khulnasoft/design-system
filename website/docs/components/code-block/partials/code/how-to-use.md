...
<div class="doc-code-block-demo-heading">
  <Kds::Text::Display @tag="h2" @size="300">Learn to write functions in JavaScript</Kds::Text::Display>
  <Kds::Text::Body @tag="p">Functions are a critical part of learning JavaScript. They are reusable chunks of code that can perform tasks like convert an object to an array.</Kds::Text::Body>
</div>
<Kds::CodeBlock
  @language="javascript"
