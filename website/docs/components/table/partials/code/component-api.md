...
This component can contain `Kds::Table::Th`, `Kds::Table::ThSort`, or `Kds::Table::Td` components.
...
This is the component that supports column sorting; use instead of `Kds::Table::Th` if creating a custom table implementation.
