...
To make the invocation more flexible and intuitive, we provide contextual components for Toggles, ListItems, Header and Footer. For example, `<Kds::Dropdown::ListItem::Separator />` would be contextually expressed as `<D.Separator />`.
...
```handlebars
<Kds::Dropdown @listPosition="bottom-left" as |D|>
  <D.ToggleButton @text="Text Toggle" />
  <D.Interactive @route="components">Item One</D.Interactive>
  <D.Interactive @route="components">Item Two</D.Interactive>
  <D.Interactive @route="components">Item Three</D.Interactive>
...
<div class="doc-dropdown-mock-text-align-right">
  <Kds::Dropdown @isInline={{true}} @listPosition="bottom-right" as |D|>
    <D.ToggleButton @text="Text Toggle" @color="secondary" />
    <D.Interactive @route="components">Item One</D.Interactive>
    <D.Interactive @route="components">Item Two</D.Interactive>
    <D.Interactive @route="components">Item Three</D.Interactive>
...
```handlebars
<Kds::Dropdown @enableCollisionDetection={{true}} as |D|>
  <D.ToggleButton @text="Text Toggle" />
  <D.Interactive @route="components">Item One</D.Interactive>
  <D.Interactive @route="components">Item Two</D.Interactive>
  <D.Interactive @route="components">Item Three</D.Interactive>
...
```handlebars
<Kds::Dropdown @height="170px" @width="250px" as |D|>
  <D.ToggleButton @text="Text Toggle" />
  <D.Interactive @route="components">Item One</D.Interactive>
  <D.Interactive @route="components">Item Two</D.Interactive>
  <D.Interactive @route="components">Item Three</D.Interactive>
...
```handlebars
<Kds::Dropdown @matchToggleWidth={{true}} as |D|>
  <D.ToggleButton @text="Text Toggle" />
  <D.Interactive @route="components">Item One</D.Interactive>
  <D.Interactive @route="components">Item Two</D.Interactive>
  <D.Interactive @route="components">Item Three</D.Interactive>
...
```handlebars
<Kds::Dropdown @height="284px" as |D|>
  ...
  <D.Footer @hasDivider={{true}}>
    <Kds::ButtonSet>
      <Kds::Button @text="Apply filters" @isFullWidth={{true}} @size="small" />
      <Kds::Button @text="Cancel" @color="secondary" @size="small" />
    </Kds::ButtonSet>
  </D.Footer>
</Kds::Dropdown>
```
...
```handlebars
<Kds::Dropdown @preserveContentInDom={{true}} as |D|>
  <D.ToggleButton @text="Text Toggle" />
...
`\{{on "click" this.myAction}}`). Internally, the component uses the [Kds::Interactive](/utilities/interactive) utility component.
...
<ul class="kds-dropdown__list">
  <Kds::Dropdown::ListItem::Interactive {{on "click" this.myAction}}>
    Run command
...
```handlebars
<ul class="kds-dropdown__list">
  <Kds::Dropdown::ListItem::Interactive {{on "click" this.myAction}} @icon="build">
    Run command
  </Kds::Dropdown::ListItem::Interactive>
</ul>
```
...
```handlebars
<ul class="kds-dropdown__list">
  <Kds::Dropdown::ListItem::Interactive @href="https://www.khulnasoft.com/request-demo/terraform">
    Request a demo
  </Kds::Dropdown::ListItem::Interactive>
</ul>
```
...
```handlebars
<ul class="kds-dropdown__list">
  <Kds::Dropdown::ListItem::Interactive @href="https://www.khulnasoft.com/request-demo/terraform" @trailingIcon="external-link">
    Request a demo
  </Kds::Dropdown::ListItem::Interactive>
</ul>
```
...
<Kds::Dropdown as |D|>
  ...
  <D.CopyItem @text="https://api.cloud.khulnasoft.com" @copyItemTitle="Endpoint URL" />
...
<Kds::Dropdown @listPosition="bottom-left" as |D|>
  ...
  <D.Footer @hasDivider={{true}}>
    <Kds::Link::Standalone @icon="list" @text="All Organizations" @color="secondary" @href="#" />
  </D.Footer>
</Kds::Dropdown>
```
...
<Kds::Dropdown @listPosition="bottom-left" as |D|>
  ...
  <D.Description @text="Create a new run task in Terraform using the URL and key below." />
  <D.Generic>
    <Kds::Link::Standalone @text="Watch tutorial video" @icon="film" @href="/" />
  </D.Generic>
</Kds::Dropdown>
```