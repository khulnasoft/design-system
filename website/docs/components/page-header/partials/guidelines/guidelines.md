...
<Kds::PageHeader as |PH|>
  ...
  <PH.Description>
    Channel created and managed automatically for you by Packer. For more information on how this channel is managed refer to the Packer <Kds::Link::Inline @icon="external-link" @href="#">documentation</Kds::Link::Inline>.
  </PH.Description>
</Kds::PageHeader>
...
Representing metadata with a set of key/value pairs is common in KhulnaSoft products and can be useful when communicating relational information between products, versioning, and other structured data.
