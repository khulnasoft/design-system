...
<Doc::ComponentApi as |C|>
  <C.Property @name="afterOptionsComponent" @type="string/contextual-component" @default="component kds/form/super-select/after-options">
  ...
  <C.Property @name="placeholderComponent" @type="string or component" @default="component">
    Set to use a custom KDS `optionGroup` component to provide visual consistency.
  </C.Property>
  ...
  <C.Property @name="groupComponent" @type="component kds/form/super-select/option-group">
