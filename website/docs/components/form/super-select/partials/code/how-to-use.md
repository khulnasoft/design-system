...
ember-power-select 8.0, and by extension the Super Select component, requires the following line in your `application.kbs`. [Read more about migrating from 7.0 to 8.0](https://ember-power-select.com/docs/migrate-7-0-to-8-0).
...
Super Select allows you to add HTML tags within options to lay out and structure content vs. `Kds::FormSelect` which only allows plain text strings as option content.
