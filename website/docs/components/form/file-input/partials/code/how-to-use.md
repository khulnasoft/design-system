...
```handlebars
<Kds::Form::FileInput::Field name="demo-profile-photo" as |F|>
...
```handlebars
<Kds::Form::FileInput::Field name="demo-profile-photo" as |F|>
  <F.Label>Upload a file <Kds::Badge @size="small" @text="Beta" /></F.Label>
  <F.HelperText>This is an <Kds::Link::Inline @href="#">experimental feature</Kds::Link::Inline>.</F.HelperText>
</Kds::Form::FileInput::Field>
```
...
```handlebars
<Kds::Form::FileInput::Field @isRequired={{true}} name="demo-profile-photo" as |F|>
  <F.Label>Upload a file</F.Label>
  <F.HelperText>File size should be a maximum of 2 MB.</F.HelperText>
</Kds::Form::FileInput::Field>
<br />
<Kds::Form::FileInput::Field @isOptional={{true}} name="demo-profile-photo" as |F|>
  <F.Label>Upload a file</F.Label>
  <F.HelperText>File size should be a maximum of 2 MB.</F.HelperText>
</Kds::Form::FileInput::Field>
```
...
```handlebars
<Kds::Form::FileInput::Field @id="my-control" name="demo-profile-photo" as |F|>
  <F.Label>Upload a file</F.Label>
</Kds::Form::FileInput::Field>
```
...
```handlebars
<Kds::Form::FileInput::Field @extraAriaDescribedBy="my-extra-element-ID" name="demo-profile-photo" as |F|>
  <F.Label>Upload a file</F.Label>
</Kds::Form::FileInput::Field>
```
