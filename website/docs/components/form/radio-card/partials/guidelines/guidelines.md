...
<Kds::Form::RadioCard::Group @name="control-position-bottom" @controlPosition="bottom" as |G|>
...
<Kds::Form::RadioCard::Group @name="control-position-left" @controlPosition="left" as |G|>
...
<Kds::Form::RadioCard::Group @alignment="left" @name="control-position-bottom" @controlPosition="bottom" as |G|>
  <G.RadioCard @maxWidth="33%" as |R|>
    <R.Icon @name="layers" />
    <R.Label>L7 permissions</R.Label>
    <R.Description>The source service may or may not connect to the destination service via unique permissions based on L7 criteria: path, header, or method.</R.Description>
...
<Kds::Form::RadioCard::Group @alignment="center" @name="control-position-bottom" @controlPosition="bottom" as |G|>
  <G.RadioCard @maxWidth="33%" as |R|>
...
<Kds::Form::RadioCard::Group @name="radio-card-horizontal-layout" as |G|>
...
<Kds::Form::RadioCard::Group @name="radio-card-vertical-layout" @controlPosition="left" @layout="vertical" as |G|>
  <G.Legend>Allow this source connect to the destination</G.Legend>
  <G.RadioCard @checked={{true}} {{on "change" this.onChange}} as |R|>
...
<Kds::Form::RadioCard::Group @name="radio-card-nested-badge" as |G|>
  ...
  <G.RadioCard @checked={{true}} {{on "change" this.onChange}} as |R|>
    ...
    <R.Generic>
      <ul class="doc-radio-card-list-demo">
        <li class="kds-typography-display-100">Connect workloads in your cloud provider network with HCP</li>
        <li class="kds-typography-display-100">Offload Consul operations to Khulnasoft Experts</li>
      </ul>
    </R.Generic>
  </G.RadioCard>
  <G.RadioCard {{on "change" this.onChange}} as |R|>
    ...
    <R.Generic>
      <ul class="doc-radio-card-list-demo">
        <li class="kds-typography-display-100">Multi-cloud artifact registry</li>
        <li class="kds-typography-display-100">Golden images workflow</li>
        <li class="kds-typography-display-100">Terraform Cloud integration</li>
        <li class="kds-typography-display-100">10 free images/month</li>
        <li class="kds-typography-display-100">250 free requests/month</li>
      </ul>
    </R.Generic>
  </G.RadioCard>
</Kds::Form::RadioCard::Group>
