...
These are the parameters that are passed down as arguments to the `Kds::Pagination::Arrow`/`Kds::Pagination::Number` child components, and from them to the `Kds::Interactive` component (used internally). For more details about how this low-level component works please refer to [its documentation page](/utilities/interactive/).
</C.Property>
...
<C.Property @name="route/model/models/replace">
These are the parameters that are passed down as arguments to the `Kds::Pagination::Arrow` child components, and from them to the `Kds::Interactive` component (used internally). For more details about how this low-level component works, please refer to [its documentation page](/utilities/interactive/).
</C.Property>
<C.Property @name="queryFunction" @type="function">
...
These are the parameters that are passed down as arguments to the `Kds::Interactive` component (used internally). For more details about how this low-level component works, please refer to [its documentation page](/utilities/interactive/).
</C.Property>
