...
For documentation around broader Figma best practices within KhulnaSoft design teams, reach out to the [Design Ops team](https://sites.google.com/khulnasoft.com/designknowledgehub/design-system) or visit the [#design-ops slack channel](https://khulnasoft.slack.com/archives/C029GL8GJDV).
...
2. Enable the libraries by locating the **KDS Design System UI Kit** team and toggling on the following:

    - [KDS - Product Components](https://www.figma.com/file/noyY6dUMDYjmySpHcMjhkN/KDS-Product---Components?t=Ooe3pkDap3cGcgAH-1)
    - [KDS - Product Foundations](https://www.figma.com/file/oQsMzMMnynfPWpMEt91OpH/KDS-Product---Foundations?t=4kdgl88SMIiEYhbA-1)
...
If you are not a member of the KDS Design System UI Kit team, you will need to look under the **Other teams** tab. If you’re having trouble finding these, search for "KDS" to find the Foundations and Components libraries and "Flight" to find the Icon library.
!!!
...
Styles, sometimes referred to as Tokens, allow consistent application of color (as a fill or stroke), typography, and effects within Figma. You can find these in the [Product Foundations library](https://www.figma.com/file/oQsMzMMnynfPWpMEt91OpH/KDS-Product---Foundations?node-id=2916%3A4&t=5MKbTaM2QzE0F5KA-1).
...
3. Select the style you wish to apply from the list of options. Ensure you choose styles within the **KDS - Product Foundations** library.
...
[Contact the Design Systems Team](https://go.hashi.co/kds-support) for support or to request a new component if a component doesn’t meet your needs.
...
KhulnaSoft product teams can use the Helios libraries published under the [KDS Design System UI Kit](https://www.figma.com/files/team/1030156573400567478) team within Figma.

- [Product Components](https://www.figma.com/file/noyY6dUMDYjmySpHcMjhkN/KDS-Product---Components?t=Ooe3pkDap3cGcgAH-1): the set of components published in the Helios Design System
- [Product Foundations](https://www.figma.com/file/oQsMzMMnynfPWpMEt91OpH/KDS-Product---Foundations?t=4kdgl88SMIiEYhbA-1): core styles including typography, color, and elevation that are consumed by Helios components for reuse in your projects
...
- [A11Y Helper Annotation Kit](https://www.figma.com/design/EEfM1jjqLfUv59eYLopn5x/KDS-A11Y-Helper-UI-Kit?m=auto&t=JLqmUYB9fZbdWaa2-6): an annotation toolkit designed to enhance collaboration between designers and engineers, ensuring the work meets accessibility (a11y) standards.
- [Wireframe UI Kit](https://www.figma.com/design/w0ukydeAsbv6sJirLxZMBo/KDS-Wireframes?m=auto&t=JLqmUYB9fZbdWaa2-6): low-fidelity versions of KDS components designed to help quickly sketch ideas and build flows.
