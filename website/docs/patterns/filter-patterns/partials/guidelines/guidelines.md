...
<div class="doc-filter-patterns-wrapper">
  ...
  <Kds::Accordion @size="small" @type="card" as |A|>
      ...
      <:toggle>
        <div class="doc-filter-patterns-accordion-toggle">
          <Kds::Text::Body
            ...
            @size="200"
            @weight="semibold"
          >Applied filters (25)</Kds::Text::Body>
          <Kds::Button
            @size="small"
            @color="tertiary"
            @icon="x"
...
For projects exceeding the complexity outlined here, please [contact the KDS team](/about/support) for support and recommendations.
