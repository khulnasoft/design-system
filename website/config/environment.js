...
module.exports = function (environment) {
  let ENV = {
    ...
    'ember-meta': {
      description:
        'The Helios Design System from KhulnaSoft provides the open source building blocks to design and implement consistent, accessible, and delightful product experiences.',
      siteName: 'Helios Design System',
      title: 'Helios Design System',
      url: 'https://design.khulnasoft.com',
    },
  };
