...
import registerEvent from '../../../modifiers/kds-register-event.ts';
...
export interface KdsPopoverPrimitiveSignature {
  Args: {
    isOpen?: boolean;
...
export default class KdsPopoverPrimitive extends Component<KdsPopoverPrimitiveSignature> {
  @tracked isOpen;
  ...
  constructor(owner: unknown, args: KdsPopoverPrimitiveSignature['Args']) {
    super(owner, args);
  ...
  setupPrimitiveToggle = modifier<SetupPrimitiveToggleModifier>(
    (element: HTMLButtonElement): void => {
      ...
      assert(
        `The toggle element of "Kds::PopoverPrimitive" must be a <button>; element received: <${element.tagName.toLowerCase()}>`,
  ...
  setupPrimitivePopover = modifier(
    (
      ...
      // Apply the `kds-anchored-position` modifier to the "popover" element
  ...
  showPopover(): void {
    try {
      ...
      warn(
        ...
        {
          id: 'kds-popover.show-popover-action.invocation-failed',
        }
      );
    }
  }
  ...
  hidePopover(): void {
    try {
      ...
      warn(
        ...
        {
          id: 'kds-popover.hide-popover-action.invocation-failed',
        }
      );
    }
  }
  ...
  togglePopover(): void {
    try {
      ...
      warn(
        ...
        {
          id: 'kds-popover.toggle-popover-action.invocation-failed',
        }
      );
    }
  }
