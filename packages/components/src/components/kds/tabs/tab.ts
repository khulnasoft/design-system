...
import type { KdsTabsTabIds } from './types';

export interface KdsTabsTabSignature {
  Args: {
    tabIds?: KdsTabsTabIds;
...
export default class KdsTabsTab extends Component<KdsTabsTabSignature> {
  /**
  ...
  get classNames(): string {
    const classes = ['kds-tabs__tab'];

    if (this.isSelected) {
      classes.push(`kds-tabs__tab--is-selected`);
    }
