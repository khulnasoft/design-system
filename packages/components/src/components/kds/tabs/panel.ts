...
import type { KdsTabsPanelIds, KdsTabsTabIds } from './types';

export interface KdsTabsPanelSignature {
  Args: {
    tabIds?: KdsTabsTabIds;
    panelIds?: KdsTabsPanelIds;
...
export default class KdsTabsPanel extends Component<KdsTabsPanelSignature> {
  /**
