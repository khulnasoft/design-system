...
export default class MenuPrimitive extends Component<MenuPrimitiveSignature> {
  ...
  constructor(owner: unknown, args: MenuPrimitiveSignature['Args']) {
    ...
    deprecate(
      'The `Kds::MenuPrimitive` component is now deprecated and will be removed in the next major version of `@khulnasoft/design-system-components`.',
      false,
      {
        id: 'kds.components.menu-primitive',
        until: '5.0.0',
        url: 'https://design.khulnasoft.com/components/menu-primitive?tab=version%20history#460',
  ...
  onClickToggle(event: MouseEvent): void {
    ...
    // we explicitly apply a focus state to the toggle element to overcome a bug in WebKit (see https://github.com/khulnasoft/design-system/commit/40cd7f6b3cb15c45f9a1235fafd0fb3ed58e6e62)
