...
export interface KdsFormHelperTextSignature {
  Args: {
...
export default class KdsFormHelperText extends Component<KdsFormHelperTextSignature> {
  /**
  ...
  get classNames(): string {
    const classes = ['kds-form-helper-text'];
