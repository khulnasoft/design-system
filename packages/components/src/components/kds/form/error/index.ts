...
import type { KdsFormErrorMessageSignature } from './message';

export const ID_PREFIX = 'error-';

const NOOP = (): void => {};

export interface KdsFormErrorSignature {
  Args: {
  ...
  Blocks: {
    default: [
      {
        Message?: ComponentLike<KdsFormErrorMessageSignature>;
      },
    ];
  };
...
export default class KdsFormError extends Component<KdsFormErrorSignature> {
  /**
