...
export interface KdsFormCharacterCountSignature {
  Args: {
...
export default class KdsFormCharacterCount extends Component<KdsFormCharacterCountSignature> {
  ...
  get classNames(): string {
    const classes = ['kds-form-character-count'];
