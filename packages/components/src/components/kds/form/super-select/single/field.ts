...
import type { KdsFormSuperSelectSingleBaseSignature } from './base.ts';
...
export interface KdsFormSuperSelectSingleFieldSignature {
  Args: KdsFormSuperSelectSingleBaseSignature['Args'] &
...
export default class KdsFormSuperSelectSingleField extends Component<KdsFormSuperSelectSingleFieldSignature> {
  get idPrefix(): string {
    return ID_PREFIX;
  }
}
