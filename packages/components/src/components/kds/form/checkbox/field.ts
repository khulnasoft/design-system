...
export interface KdsFormCheckboxFieldSignature {
...
const KdsFormCheckboxField =
  templateOnlyComponent<KdsFormCheckboxFieldSignature>();

export default KdsFormCheckboxField;
