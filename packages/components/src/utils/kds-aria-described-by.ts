...
import type { KdsFormFieldSignature } from '../components/kds/form/field/';
import type { KdsFormFieldsetSignature } from '../components/kds/form/fieldset/';
...
type AriaDescribedByArgs = KdsFormFieldSignature | KdsFormFieldsetSignature;
